		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#demoproject1061023-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"demoproject1061023-display": {
								"semanticObject": "demoproject1061023",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demo.project1061023",
									"url": sap.ui.require.toUrl("demo/project1061023")
								}
							}
						}
					}
